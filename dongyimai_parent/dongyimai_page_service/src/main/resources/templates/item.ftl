...
<body ng-app="dongyimai" ng-controller="itemController" ng-init="loadSku()">
    ...
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb">
                <li>
                    <a href="javascript:void(0)">${itemCat1}</a>
                </li>
                <li>
                    <a href="javascript:void(0)">${itemCat2}</a>
                </li>
                <li>
                    <a href="javascript:void(0)">${itemCat3}</a>
                </li>
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}"
                                                  style="width: 400px;height: 400px;"/></span>
                    </div>
                    <!--下方的缩略图-->
                            ...
                            <dl>
                                ...
                                <#list spec.attributeValue as val>
                                    <dd><a href="javascript:;"
                                           class="{{isSelected('${spec.attributeName}','${val}') ? 'selected':''}}"
                                           ng-click="selectSpec('${spec.attributeName}','${val}')">${val}<span
                                                    title="点击取消选择">&nbsp;</span></a>
                                    </dd>
                                </#list>
